...
<!--引入bootstrap样式表  -->
	...
	<!-- 引入css文件 -->
	<link rel="stylesheet"  type="text/css"  href="${pageContext.request.contextPath }/css/showGroups.css"/>
	<!--引入less -->
	<script src="http://cdn.bootcss.com/less.js/1.7.0/less.min.js"></script>
     <!--引入js文件  -->
     <script type="text/javascript" src="${pageContext.request.contextPath }/js/showGroups.js"></script>
   <!--引入md5  -->
  ...
  <body>
    <div class="container">
        ...
        <div class="row" id="scrollLoad">
           
        </div>
        <input id="groupsList" type="hidden" value=${groups } />
        <input id="forSearch" type="hidden" value=${forSearch } />
        <input type="hidden" id="isLogin" value=${sessionScope.isLogin }> 
   </div>
  </body>
</html>
