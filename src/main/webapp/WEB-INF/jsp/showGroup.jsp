...
<html>
  <head>
    ...
    <title>My JSP 'showGroup.jsp' starting page</title>
...
<!--引入bootstrap样式表  -->
	...
	<!-- 引入css文件 -->
	<link rel="stylesheet"  type="text/css"  href="${pageContext.request.contextPath }/css/showGroup.css"/>
	<!--引入less -->
	<!-- <script src="http://cdn.bootcss.com/less.js/1.7.0/less.min.js"></script> -->
     <!--引入js文件  -->
     <script type="text/javascript" src="${pageContext.request.contextPath }/js/showGroup.js"></script>
     <!--引入md5  -->
    ...
    <!--暂时决定分上下2块
      ...
      <div class="container">
            ...
            <div class="row" id="scrollPage">
	            <div class="row" id="scrollPage1"> </div>
	            <div class="row" id="scrollPage2"> 
	                <!-- 水平滑动 -->
	                <!--js动态加载滑动板块，每个滑动板块最多有5条成员信息
	                用左右箭头控制滑动  -->
	            </div>
	        </div>
	            ...
	            <input id="pirateNameList" type="hidden" value=${pirateNameList }>
                <input type="hidden" id="isLogin" value=${sessionScope.isLogin }> 
   </div>
  </body>
</html>
