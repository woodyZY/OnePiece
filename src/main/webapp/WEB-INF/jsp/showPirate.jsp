...
<html>
  <head>
    ...
    <title>My JSP 'showPirate.jsp' starting page</title>
	...
	<!-- 引入css文件 -->
	<link rel="stylesheet"  type="text/css"  href="${pageContext.request.contextPath }/css/showPirate.css"/>
	<!--引入less -->
	<!-- <script src="http://cdn.bootcss.com/less.js/1.7.0/less.min.js"></script> -->
     <!--引入js文件  -->
     <script type="text/javascript" src="${pageContext.request.contextPath }/js/showPirate.js"></script>
    <!--引入md5  -->
  ...
  <body>
    <div class="container">
        ...
        <div id="row2">
           <div id="left-img"></div>
           <div id="right-info">
               <div class="row-info" id="pirateName">
                   <div class="infoName">海贼名字</div>
               </div>
               <div class="row-info" id="groupName">
                  <div class="infoName">所属海贼团</div>
               </div>
               <div class="row-info" id="position">
                  <div class="infoName">职位</div>
               </div>
               <div class="row-info" id="bounty">
                  <div class="infoName">赏金</div>
               </div>
               <div class="row-info" id="weapon">
                   <div class="infoName">能力</div>
               </div>
               <div class="row-info" id="skills">
                    <div class="infoName">技能</div>
               </div>
               <div class="row-info" id="story">
                  <div class="infoName">背景故事</div>
               </div>
           </div>
        </div>
        <input id="pirate" type="hidden" value=${pirate } />
        <input type="hidden" id="isLogin" value=${sessionScope.isLogin }> 
   </div>
  </body>
</html>
