...
<!--引入bootstrap样式表  -->
	...
	<script src="http://cdn.bootcss.com/less.js/1.7.0/less.min.js"></script>
     <!--引入js文件  -->
     <script type="text/javascript" src="${pageContext.request.contextPath }/js/overview.js"></script>
     <!--引入md5  -->
  ...
  <body>
    <div class="container">
       ...
       <div class="row" id="row2">
          <!--势力分布 ：世界政府  海军  革命军  海贼-->
          <div class="row img" id="leftTop">
             <div class="text" id="text1">世界政府</div>
             <img alt="" src="${pageContext.request.contextPath }/img/5.jpg">
          </div>
          <div class="rowmask leftTop-mask"></div>
          
          <div class="row img" id="rightTop">
            <div class="text" id="text2">海军</div>
            <img alt="" src="${pageContext.request.contextPath }/img/2.jpg">
          </div>
          <div class="rowmask rightTop-mask"></div>
          
          <div class="row img" id="leftBottom">
            <div class="text" id="text3">革命军</div>
            <img alt="" src="${pageContext.request.contextPath }/img/3.jpg">
          </div>
          <div class="rowmask leftBottom-mask"></div>
          
          <div class="row img" id="rightBottom">
            <div class="text" id="text4">海贼</div>
            <img alt="" src="${pageContext.request.contextPath }/img/4.jpg">
          </div>
          <div class="rowmask rightBottom-mask"></div>
