...
<html>
  ...
  <!--引入bootstrap样式表  -->
	...
	<script type="text/javascript"
		...
		<!--引入js文件  -->
	<script type="text/javascript" src="${pageContext.request.contextPath }/js/showAdminPage.js"></script>
	<!--引入md5  -->
	<script type="text/javascript" src="${pageContext.request.contextPath }/js/md5.js"></script>
	<script type="text/javascript" src="<%=basePath %>js/jquery.easing.min.js"></script>
	<!-- 引入css文件 -->
	<link rel="stylesheet"  type="text/css"  href="${pageContext.request.contextPath }/css/showAdminPage.css"/>
  ...
  <body>
    ...
    <div class="row" id="row1">
		...
		<!-- /.navbar-collapse --> </nav>
           ...
           <div  id="searchInput">
              <input type="text"  name="search" id="searchString" placeholder="请输入关键字">
           </div>
    <div class="row" id="groupPage">
